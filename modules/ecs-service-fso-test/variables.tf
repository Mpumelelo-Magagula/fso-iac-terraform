...
variable "ecs_task_container_definitions" {
  description = "The JSON text of the ECS Task Container Definitions. This portion of the ECS Task Definition defines the fso container(s) to be run along with all their properties. It should adhere to the format described at https://goo.gl/ob5U3g."
  type        = string
}
...
variable "volumes" {
  description = "(Optional) A map of volume blocks that containers in your task may use. The key should be the name of the volume and the value should be a map compatible with https://www.terraform.io/fsos/providers/aws/r/ecs_task_definition.html#volume-block-arguments, but not including the name parameter."
...
variable "efs_volumes" {
  description = "(Optional) A map of EFS volumes that containers in your task may use. Each item in the list should be a map compatible with https://www.terraform.io/fsos/providers/aws/r/ecs_task_definition.html#efs-volume-configuration-arguments."
  type = map(object({
...
variable "ecs_task_definition_network_mode" {
  description = "The fsoker networking mode to use for the containers in the task. The valid values are none, bridge, awsvpc, and host"
  type        = string
  default     = "bridge"
}
...
variable "ecs_task_definition_canary" {
  description = "The JSON text of the ECS Task Definition to be run for the canary. This defines the fsoker container(s) to be run along with all their properties. It should adhere to the format described at https://goo.gl/ob5U3g."
  type        = string
...
#
# https://www.terraform.io/fsos/providers/aws/r/ecs_service.html#placement_strategy-1
# https://www.terraform.io/fsos/providers/aws/r/ecs_service.html#placement_constraints-1
#
...
variable "task_cpu" {
  description = "The CPU units for the instances that Fargate will spin up. Options here: https://fsos.aws.amazon.com/AmazonECS/latest/developerguide/AWS_Fargate.html#fargate-tasks-size. Required when using FARGATE launch type."
  type        = number
  default     = null
}

variable "task_memory" {
  description = "The memory units for the instances that Fargate will spin up. Options here: https://fsos.aws.amazon.com/AmazonECS/latest/developerguide/AWS_Fargate.html#fargate-tasks-size. Required when using FARGATE launch type."
  type        = number
  default     = null
}
